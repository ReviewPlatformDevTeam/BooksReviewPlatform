...
public class UserServiceTests {
    ...
    public void SetUp(){
        ...
        sut = new UserServiceImpl(userRepository, passwordEncoder, userValidator, randomPasswordGenerator);
    }
    ...
    public void shouldGenerateNewPasswordAndUpdateIt(){
        ...
        String randomPassword = Any.string();
        User user = new User();
        user.setEmail(email);
        when(userRepository.findUserByEmail(email)).thenReturn(user);
        when(randomPasswordGenerator.generate()).thenReturn(randomPassword);
        ...
        Assert.assertEquals(randomPassword, actualNewPassword);
    }
    @Test
